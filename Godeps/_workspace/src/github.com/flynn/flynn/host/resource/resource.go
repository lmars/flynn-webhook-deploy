...
import (
	...
	"github.com/lmars/flynn-webhook-deploy/Godeps/_workspace/src/github.com/docker/docker/pkg/units"
	"github.com/lmars/flynn-webhook-deploy/Godeps/_workspace/src/github.com/flynn/flynn/pkg/typeconv"
)
